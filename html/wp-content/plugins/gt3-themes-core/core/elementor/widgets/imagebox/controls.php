...
$widget->add_control(
    ...
    [
        ...
        'default' => 'default',
        'prefix_class' => 'elementor-image_icon-position-',
    ]
);
...
$widget->add_responsive_control(
    ...
    [
        ...
        'selectors' => [
            '{{WRAPPER}} .gt3-core-imagebox-wrapper .gt3-core-imagebox-img' => 'width: {{SIZE}}{{UNIT}};',
        ],
        'condition' => [
            'type' => 'image',
        ],
...
$widget->add_group_control(
    ...
    [
        ...
        'selectors' => '{{WRAPPER}} .gt3-core-imagebox-content .gt3-core-imagebox-description',
