...
$widget->add_control(
	...
	array(
		...
		'label_block' => true,
		'selectors'   => array(
			'{{WRAPPER}}.elementor-widget-gt3-core-piechart .gt3_elementor_pie_chart canvas' => 'max-width: calc(100% - 2*{{SIZE}}{{UNIT}}); ',
			'{{WRAPPER}}.elementor-widget-gt3-core-piechart .gt3_elementor_pie_chart' => 'padding-top: {{SIZE}}{{UNIT}}; ',
		),
	)
);
...
$widget->add_group_control(
	...
	array(
		...
		'selector' => '{{WRAPPER}}.elementor-widget-gt3-core-piechart .gt3_elementor_pie_chart strong',
	)
);
