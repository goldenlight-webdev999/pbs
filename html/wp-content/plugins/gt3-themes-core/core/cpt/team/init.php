...
class GT3TeamRegister {
	...
	private function registerPostType() {
		register_post_type( 'team',
			array(
				'labels'          => array(
					'name'          => __( 'Team', 'gt3_themes_core' ),
					'singular_name' => __( 'Team Member', 'gt3_themes_core' ),
					'add_item'      => __( 'New Team Member', 'gt3_themes_core' ),
					'add_new_item'  => __( 'Add New Team Member', 'gt3_themes_core' ),
					'edit_item'     => __( 'Edit Team Member', 'gt3_themes_core' )
				),
				'public'          => true,
				'has_archive'     => true,
	...
	private function registerTax() {
		$labels = array(
			'name'              => __( 'Team Categories', 'gt3_themes_core' ),
			'singular_name'     => __( 'Team Category', 'gt3_themes_core' ),
			'search_items'      => __( 'Search Team Categories', 'gt3_themes_core' ),
			'all_items'         => __( 'All Team Categories', 'gt3_themes_core' ),
			'parent_item'       => __( 'Parent Team Category', 'gt3_themes_core' ),
			'parent_item_colon' => __( 'Parent Team Category:', 'gt3_themes_core' ),
			'edit_item'         => __( 'Edit Team Category', 'gt3_themes_core' ),
			'update_item'       => __( 'Update Team Category', 'gt3_themes_core' ),
			'add_new_item'      => __( 'Add New Team Category', 'gt3_themes_core' ),
			'new_item_name'     => __( 'New Team Category Name', 'gt3_themes_core' ),
			'menu_name'         => __( 'Team Categories', 'gt3_themes_core' ),
		);
