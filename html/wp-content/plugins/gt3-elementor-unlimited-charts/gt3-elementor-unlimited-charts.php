...
function gt3_elementor_unlimited_chart__meta_links( $meta_fields, $file ) {
	if ( plugin_basename( __FILE__ ) == $file ) {
		/*$meta_fields[] = "<a href='https://wordpress.org/support/plugin/gt3-elementor-unlimited-charts' target='_blank'>" . esc_html__( 'Support Forum', 'gt3_unlimited_chart' ) . "</a>";
		$meta_fields[] = "<a href='https://wordpress.org/support/plugin/gt3-elementor-unlimited-charts/reviews/#new-post' target='_blank' title='" . esc_html__( 'Rate', 'gt3_unlimited_chart' ) . "'>
