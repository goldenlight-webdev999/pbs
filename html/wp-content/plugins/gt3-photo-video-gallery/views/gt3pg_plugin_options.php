		...
		<form action="" method="post" class="gt3pg_page_settings">
			<div class="gt3pg_main_line">
				...
				<div class="gt3pg_links">
					<a href="<?php echo esc_attr(GT3PG_WORDPRESS_URL) ?>" target="_blank"><?php esc_html_e('Need Help?', 'gt3pg') ?></a>
				</div>
				<div class="clear"></div>
				<?php
			...
			if(function_exists('register_block_type')) {
				...
				wp_enqueue_script('gt3pg_settings', GT3PG_PLUGINROOTURL.'/dist/settings.js');
				wp_enqueue_style('gt3pg_settings', GT3PG_PLUGINROOTURL.'/dist/settings.css');
				?>
