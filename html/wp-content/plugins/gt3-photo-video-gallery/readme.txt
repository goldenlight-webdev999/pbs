...
Tags: photo gallery, gallery, gallery block, image gallery, gutenberg, wordpress gallery plugin, gutenberg gallery block, gutenberg block, responsive gallery, block
...
This powerful photo gallery plugin lets you extend the functionality of the default WordPress image gallery. You can easily create photo gallery, video gallery, slider and much more...

== Description ==

<h3>What is GT3 Photo Gallery and Video Gallery?</h3>

This Gutenberg blocks compatible, powerful and free photo gallery and video gallery WordPress plugin allows you to extend the functionality of the default WordPress image gallery. You can easily customize the look and feel of the photo or video gallery using the custom GT3 gallery settings panel.

Create a new look for your awesome photo galleries with ease. The current version of the photo & video gallery is fully compatible with the Gutenberg blocks editor and WordPress 5.1 + You can easily use GT3 photo and video gallery Gutenberg block to create awesome image galleries.

The Pro version of our GT3 Photo & Video Gallery plugin allows you to convert the old photo galleries into Gutenberg gallery blocks automatically. It's very convenient to have such an option in the gallery plugin.

The new Gutenberg block photo galleries and Elementor page builder compatible galleries will be released soon. Follow us on [Twitter](https://twitter.com/gt3themes/) and [Facebook](https://www.facebook.com/gt3themes/) to get latest news and updates.
...
* Elementor photo gallery widgets
* WPBakery photo gallery modules
...
<h3>Watch this Video to See the Photo Gallery Setup</h3>
In this video you will see how easily you can set up a new photo gallery or convert the existing WordPress gallery into Gutenberg photo gallery.

[youtube http://www.youtube.com/watch?v=eIUfmr91D8g]

<h3>The advantages of the plugin</h3>

* Gutenberg blocks and WordPress 5.1+ compatible
...
* Plugin support from our gt3themes team
* And much more...
...
= How to add video to photo gallery plugin? =
...
At the moment it's not possible to use it within Elementor page builder because it requires a custom widget to be created. We are working on it at the moment, the update will be released in a few weeks. There will be a custom gallery widget. You will get the same functionality like in the Gutenberg gallery block.
