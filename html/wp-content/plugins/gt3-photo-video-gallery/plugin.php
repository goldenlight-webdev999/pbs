...
define('GT3PG_PLUGIN_VERSION', '2.3.4.4');
...
function gt3pg_register_admin_css_js(){
	#CSS (Admin)
	wp_enqueue_style('gt3pg_admin_css', GT3PG_PLUGINROOTURL.'/dist/admin.css', null, GT3PG_PLUGIN_VERSION);
...
//function gt3pg_register_front_css_js(){
	#CSS (Front)
//	wp_enqueue_style('gt3pg_css', GT3PG_PLUGINROOTURL.'/dist/gt3pg.css', null, GT3PG_PLUGIN_VERSION);
	#JS (Front)
//	wp_enqueue_script('gt3pg_js', GT3PG_PLUGINROOTURL.'/dist/gt3pg.js', array( 'jquery' ), GT3PG_PLUGIN_VERSION, true);
//}
