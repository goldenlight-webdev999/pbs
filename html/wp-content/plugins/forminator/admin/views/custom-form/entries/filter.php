	...
	<div class="sui-row">
		...
		<div class="sui-col-md-3">
			...
			<select id="forminator-forms-filter--sort-order" name="order">
				<option value="DESC" <?php selected( 'DESC', $order ); ?>><?php esc_html_e( 'Descending', Forminator::DOMAIN ); ?></option>
				<option value="ASC" <?php selected( 'ASC', $order ); ?>><?php esc_html_e( 'Ascending', Forminator::DOMAIN ); ?></option>
			</select>
