			...
			<?php if(!empty($client_name)) {
				...
				<div class="grid__item  one-half  lap-and-up-one-quarter  push-half--bottom">
					<div class="entry__meta-box">
						<span class="meta-box__title"><?php esc_attr_e('Client', 'zohar'); ?></span>
				...
				if(!empty($event_date)) {
					...
					<div class="grid__item  one-half  lap-and-up-one-quarter  push-half--bottom">
						<div class="entry__meta-box">
							<span class="meta-box__title"><?php esc_html_e('Event date', 'zohar'); ?></span>
				...
				if(!empty($number_of_images)) {
					...
					<div class="grid__item  one-half  lap-and-up-one-quarter  push-half--bottom">
						<div class="entry__meta-box">
							<span class="meta-box__title"><?php esc_html_e('Images', 'zohar'); ?></span>
				...
				if(!empty($file)) {
					...
					<div class="grid__item  one-half  lap-and-up-one-quarter  push-half--bottom">
						<div class="entry__meta-box">
							<button class="button-download  js-download" onclick="window.open('<?php echo esc_url($file); ?>')"><?php esc_html_e('Download', 'zohar'); ?>
							</button>
						</div>
					</div>
					<?php
