...
add_filter( 'gt3/core/render/blog/post_author', function () {
	return '<span class="post_author">' . esc_html__('by', 'zohar') . ' <a href="' . esc_url(get_author_posts_url(get_the_author_meta('ID'))) . '">' . esc_html(get_the_author_meta('display_name')) . '</a></span>';
});
	...
	if ($show_share == "1" || $show_likes == "1") {
		...
		if ($show_share == "1") {
			...
			<div class="post_share_block">
				<a href="'. esc_js("javascript:void(0)") .'"><span class="sharing_title">'. esc_html__('Share', 'zohar') .'</span></a>
