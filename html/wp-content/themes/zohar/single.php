...
if ( !post_password_required() ) {
            ...
            <div class="content-container span<?php echo (int)esc_attr($column); ?>">
                <section id='main_content'>
							...
							<div class="item_wrapper">
								<div class="blog_content">
									<?php
										...
										$icon_post_comments = '<span class="post_comments_icon"><i class="fa fa-comment-o"></i></span>';
											...
											<div class="post_block_info">
												<div class="listing_meta_wrap">
													<div class="listing_meta">
														...
														<span class="post_author"><?php echo esc_html__('by', 'zohar') ?> <a href="<?php echo esc_url(get_author_posts_url(get_the_author_meta('ID'))); ?>"><?php echo esc_html(get_the_author_meta('display_name')); ?></a></span>
													...
													<div class="blog_post_info">
														...
														if ($show_share == "1") { ?>
															...
															<div class="post_share_block">
																<a href="<?php echo esc_js("javascript:void(0)"); ?>"><span class="sharing_title"><?php echo esc_html__('Share', 'zohar'); ?></span></a>
										...
										the_content();
										wp_link_pages(array(
											'before' => '<div class="page-link"><span class="pagger_info_text">' . esc_html__('Pages', 'zohar') . ': </span>',
											'after' => '</div>',
					...
					if ( $show_post_featured == "1" ) :
		                            	...
		                            	<div class="blog_content">'
											...
											if (!(bool)$featured_image[0]) {
												...
												<div class="gt3_module_button_list">
													<a href="'.esc_url( get_permalink() ).'">'. esc_html__('Read More', 'zohar') .'</a>
												</div>';
											}
											$compile_related .= '
											<div class="clear"></div>
						...
						if ($compile_related != '') {
							echo '
							<div class="gt3_module_title"><h2>' . esc_html__('Related Posts', 'zohar') . '</h2></div>
	...
	<div class="single_prev_next_posts">
		<div class="container">
			<?php
			if (!empty($prev_post)) {
				previous_post_link('<div class="fleft">%link</div>', '<span class="gt3_post_navi" data-title="' . esc_attr($prev_post->post_title) . '">' . esc_html__('Prev', 'zohar') . '</span>');
			}
			...
			if (!empty($next_post)) {
				next_post_link('<div class="fright">%link</div>', '<span class="gt3_post_navi" data-title="' . esc_attr($next_post->post_title) . '">' . esc_html__('Next', 'zohar') . '</span>');
			}
			?>
		</div>
	</div>
	...
	<div class="pp_block">
		<div class="container_vertical_wrapper">
			<div class="container a-center pp_container">
				<h1><?php echo esc_html__('Password Protected', 'zohar'); ?></h1>
				<?php the_content(); ?>
			</div>
		</div>
	</div>
