                        ...
                        <div class="wrapper_404 height_100percent pp_block">
                            <div class="container_vertical_wrapper">
                                <div class="container a-center pp_container">
                                    <h1><?php echo esc_html__('Oops!', 'zohar'); ?> <?php echo esc_html__('Not Found!', 'zohar'); ?></h1>
                                    <h2><?php echo esc_html__('Apologies, but we were unable to find what you were looking for.', 'zohar'); ?></h2>
