...
function gt3_custom_styles() {
    ...
    *{
    ...
    .secondary {
        ...
        font-weight:' . $content_secondary_font_weight . ';
    ...
    .sidebar .widget.gt3_widget.widget_search .search_form:before,
    ...
    .column_menu>div>ul {
        ...
        letter-spacing: ' . esc_attr($menu_font_letter_spacing) . ';
        text-transform: ' . esc_attr($menu_font_text_transform) . ';
    }
    ...
    div:not(.packery_wrapper) .blog_post_preview .listing_meta {
        color: rgba('.gt3_HexToRGB($content_color).', 0.85);
    }
    ...
    .main_wrapper .content-container ol > li:before,
    ...
    .gt3_custom_tooltip:after {
        border-color: ' . $header_font_color . ' transparent transparent transparent;
    }
	...
	.elementor-shortcode .mc_form_inside.has_only_email .mc_signup_submit:hover {
        background-color: rgba('.gt3_HexToRGB($content_color).', 0.9);
    }
    ul.pagerblock li a,
    ...
    .woocommerce nav.woocommerce-pagination ul li a {
        color: rgba('.gt3_HexToRGB($content_color).', 0.5);
    }
    ...
    foreach ($sections as $section) {
        ...
        .gt3_header_builder__section--'.$section.' .gt3_header_builder__section-container{
            height:' . (int)${'side_' . $section . '_height'} . 'px;
            background-color:' . esc_attr(${'side_' . $section . '_background2'}) . ';
        }
