<?php
	...
	$post_author = '<span class="post_author">' . esc_html__('by', 'zohar') . ' <a href="' . esc_url(get_author_posts_url(get_the_author_meta('ID'))) . '">' . esc_html(get_the_author_meta('display_name')) . '</a></span>';
	...
	<div class="blog_post_preview format-<?php echo esc_attr($pf).esc_attr($class);?>">
		<div class="item_wrapper">
			...
			<?php
				...
				echo (strlen($post_descr) ? $post_descr : '') . '<div class="clear post_clear"></div><div class="gt3_post_footer"><div class="gt3_module_button_list"><a href="'. esc_url(get_permalink()) .'">'. esc_html__('Read More', 'zohar') .'</a></div>';
				?>
